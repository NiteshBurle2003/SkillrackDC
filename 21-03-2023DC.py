'''
The program must accept an integer N as the input. The program must print a value for each digit
as the digit multiplied by its position value.
