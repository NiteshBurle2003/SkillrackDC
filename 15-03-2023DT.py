'''
The program must accept three integers as the input. The program must calculate the product of
all the possible combinations of two integers among the three integers. Then the program must
print the sum of unique product values.
